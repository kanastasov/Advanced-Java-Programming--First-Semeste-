...
public class Share {
     ...
     * 
     * @param shareWatcher The stock watcher to add
    ...
    /** This method removes a stock watcher from the list of registered watchers.
     * 
     * @param shareWatcher The stock watcher to remove
     * @return true if the stock watcher is remove successfully
     */
     ...
     * watchers are updated with new price.
     * 
