...
/**TBOFF31 a computer sold by Techno-Byte.
 *
 * @author Anastasov
 */
public class TBOFF31 extends Computer {
    /**
     * @param memory represent the memory of PC.
     */
    protected int memory = 4;
    
    /**
     * @param disc represent the disc of PC.
     */
    protected int disc = 750;
    
    
    /**
     * @param processor represent the processor of PC.
     */
    protected double processor = 3.00;
    
    /**
     * @param img stores the images for the GUI.
     */
    protected ImageIcon []img = {new ImageIcon("TBOFF31.gif")};
    
    /**
     * @param price represent the price for the PC.
     */
    protected double price = 499;
     ...
     */
    public TBOFF31(int memory, int disc, double processor, ImageIcon []img, double price) {
        this.memory = memory;
        this.disc = disc;
