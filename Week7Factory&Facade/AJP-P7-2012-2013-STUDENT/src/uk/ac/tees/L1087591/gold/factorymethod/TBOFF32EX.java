 ...
 * @author Anastasov
 */
public class TBOFF32EX extends Computer {
    /**
     ...
     */
    protected ImageIcon []img = {new ImageIcon("TBOFF32EX.gif")};
     ...
     */
    public TBOFF32EX(int memory, int disc, double processor, ImageIcon []img, double price) {
        this.memory = memory;
        this.disc = disc;
