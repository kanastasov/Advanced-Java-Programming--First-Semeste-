...
/**TBXX6 is a computer sold by Techno-Byte.
 *
 * @author Anastasov
 */
public class TBXX6 extends Computer {
     ...
     */
    protected ImageIcon []img = {new ImageIcon("TBXX6.gif")};
    
    /**
     * @param price represent the price for the PC.
     */
    protected double price = 599;
     ...
     */
    public TBXX6(int memory, int disc, double processor, ImageIcon []img, double price) {
        this.memory = memory;
        this.disc = disc;
        this.processor = processor;
        this.img = img;
        this.price = price;
        System.out.println("Text from TBXX6 constructor");
    }
