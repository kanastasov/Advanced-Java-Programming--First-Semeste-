...
public class MalfunctionHandlerTest {
    ...
    public void testProcessMalfunction() {
        ...
        // Clean log file
        FileUtility.resetFile(new File("log-silver.txt"));
        ...
        // Check  log file
        final String actualOutput = FileUtility.readFile(new File("log-silver.txt"));
        final String expectedOutput = FileUtility.readFile(new File("expected-silver.txt"));
